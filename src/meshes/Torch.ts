...
export default class Torch {
    ...
    async load() {
        await SceneLoader.ImportMeshAsync('', '/meshes/', 'torch.glb', this._scene);

        this._mesh = this._scene.getMeshByName('torch') as Mesh

        this._mesh.scaling = new Vector3(0.02,0.02,0.02);
        this._mesh.rotation = new Vector3(0.37,0,0)
